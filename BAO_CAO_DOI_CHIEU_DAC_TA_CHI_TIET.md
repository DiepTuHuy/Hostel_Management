...
| :--- | :--- | :--- | :--- | :---: | :--- |
| **UC01** | Đăng ký tài khoản | `RegisterPage.jsx` | `POST /api/auth/register`<br>`POST /api/auth/verify-otp` | 🟢 | **Khớp hoàn toàn**: Đăng ký -> Sinh OTP gửi qua Gmail thật bằng Nodemailer -> Nhập OTP -> Kích hoạt tài khoản thành `active`. |
